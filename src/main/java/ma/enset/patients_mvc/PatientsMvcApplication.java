...
public class PatientsMvcApplication {
    ...
    CommandLineRunner commandLineRunner(PatientRepository patientRepository) {
        return args -> {
            patientRepository.save(
                    new Patient(null,"Abdellah",new Date(),false,122));
            patientRepository.save(
                    new Patient(null,"Said",new Date(),true,321));
            patientRepository.save(
                    new Patient(null,"Karim",new Date(),true,165));
            patientRepository.save(
                    new Patient(null,"Souad",new Date(),false,132));
   ...
   //@Bean
    CommandLineRunner saveUsers(SecurityService securityService){
        return args -> {
securityService.saveNewUser("abdellah","1234","1234");
...
securityService.addRoleToUser("abdellah","USER");
securityService.addRoleToUser("abdellah","ADMIN");
